...
MODEL_PATH = os.environ.get('MODEL_PATH', '/root/autodl-tmp/ChatGLM3/finetune_demo/output/checkpoint-3000')
...
def predict(history, max_length, top_p, temperature):
    ...
    streamer = TextIteratorStreamer(tokenizer, timeout=60, skip_prompt=True, skip_special_tokens=False)
    generate_kwargs = {
